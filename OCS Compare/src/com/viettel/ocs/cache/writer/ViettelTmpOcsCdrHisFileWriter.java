...
public class ViettelTmpOcsCdrHisFileWriter implements CacheWriter {
	...
	public ViettelTmpOcsCdrHisFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.viettelTmpOcsCdrHis = new EhcacheWrapper<String, String>("viettelTmpOcsCdrHis", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(viettelTmpOcsCdrHis.get(key));
		...
		viettelTmpOcsCdrHis.delete(key);
	}
