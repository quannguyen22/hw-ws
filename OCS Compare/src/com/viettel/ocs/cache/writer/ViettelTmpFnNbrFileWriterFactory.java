 ...
 * @author Alex Snaps
 */
public class ViettelTmpFnNbrFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpFnNbrFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_FN_NBR + ".txt"));
	}
}