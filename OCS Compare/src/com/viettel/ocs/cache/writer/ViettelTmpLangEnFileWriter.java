...
public class ViettelTmpLangEnFileWriter implements CacheWriter {
	...
	public ViettelTmpLangEnFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.viettelTmpLangEn = new EhcacheWrapper<String, String>("viettelTmpLangEn", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(viettelTmpLangEn.get(key));
