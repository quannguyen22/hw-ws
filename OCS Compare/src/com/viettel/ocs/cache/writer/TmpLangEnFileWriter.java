...
public class TmpLangEnFileWriter implements CacheWriter {
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(tmpLangEn.get(key));
