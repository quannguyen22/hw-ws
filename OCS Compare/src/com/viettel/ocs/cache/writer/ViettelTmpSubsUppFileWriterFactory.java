 ...
 * @author Alex Snaps
 */
public class ViettelTmpSubsUppFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpSubsUppFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_SUBS_UPP + ".txt"));
	}
}