 ...
 * @author Alex Snaps
 */
public class ViettelTmpVtCutSeaFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpVtCutSeaFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_VT_CUT_SEA + ".txt"));
	}
}