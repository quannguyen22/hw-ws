 ...
 * @author Alex Snaps
 */
public class ViettelTmpFnSrvFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpFnSrvFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_FN_SRV + ".txt"));
	}
}