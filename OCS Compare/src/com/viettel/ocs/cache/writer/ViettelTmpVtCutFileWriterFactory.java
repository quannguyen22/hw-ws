 ...
 * @author Alex Snaps
 */
public class ViettelTmpVtCutFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpVtCutFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_VT_CUT + ".txt"));
	}
}