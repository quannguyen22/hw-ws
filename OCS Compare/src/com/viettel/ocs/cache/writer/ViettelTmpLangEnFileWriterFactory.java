 ...
 * @author Alex Snaps
 */
public class ViettelTmpLangEnFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpLangEnFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_LANG_EN + ".txt"));
	}
}