...
public class ViettelTmpRecharge24hFileWriter implements CacheWriter {
	...
	public ViettelTmpRecharge24hFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.viettelTmpRecharge24h = new EhcacheWrapper<String, String>("viettelTmpRecharge24h", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(viettelTmpRecharge24h.get(key));
		...
		viettelTmpRecharge24h.delete(key);
	}
