...
public class TmpRecharge24hFileWriter implements CacheWriter {
	...
	public TmpRecharge24hFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.tmpRecharge24h = new EhcacheWrapper<String, String>("tmpRecharge24h", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(tmpRecharge24h.get(key));
