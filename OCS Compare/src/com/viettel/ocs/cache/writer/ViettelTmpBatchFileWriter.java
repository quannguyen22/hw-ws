...
public class ViettelTmpBatchFileWriter implements CacheWriter {
	...
	public ViettelTmpBatchFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.viettelTmpBatch = new EhcacheWrapper<String, String>("viettelTmpBatch", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(viettelTmpBatch.get(key));
