 ...
 * @author Alex Snaps
 */
public class ViettelTmpBlackListSubsFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpBlackListSubsFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_BLACKLIST_SUBS + ".txt"));
	}
}