 ...
 * @author Alex Snaps
 */
public class ViettelTmpAcmMFileWriterFactory extends CacheWriterFactory {
	...
	public CacheWriter createCacheWriter(final Ehcache ehcache, final Properties properties) {
		return new ViettelTmpAcmMFileWriter(new File(PATH + "/" + Constant.VIETTEL_TMP_ACM_M + ".txt"));
	}
}