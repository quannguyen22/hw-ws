...
public class ViettelTmpFnNbrFileWriter implements CacheWriter {
	...
	public ViettelTmpFnNbrFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.viettelTmpFnNbr = new EhcacheWrapper<String, String>("viettelTmpFnNbr", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(viettelTmpFnNbr.get(key));
