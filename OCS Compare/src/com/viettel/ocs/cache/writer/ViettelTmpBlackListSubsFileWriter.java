...
public class ViettelTmpBlackListSubsFileWriter implements CacheWriter {
	...
	public ViettelTmpBlackListSubsFileWriter(final File file) {
		this.file = file;

		// Khoi tao cache de get value tu key
		// Get gia tri tu doi tuong element dang bi sai vi thua chu t o dau dong.
		CacheManager cacheManager = CacheManager.getInstance();
		this.viettelTmpBlackListSubs = new EhcacheWrapper<String, String>("viettelTmpBlackListSubs", cacheManager);
	}
	...
	public synchronized void write(final Element element) throws CacheException {
		...
		String value = StringUtils.trimToEmpty(viettelTmpBlackListSubs.get(key));
		...
		viettelTmpBlackListSubs.delete(key);
	}
